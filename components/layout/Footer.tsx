      ...
      {referralLinks.length > 0 && (
        <div className="border-b-2 border-surface">
          <aside
            ...
            className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-8 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8"
          >
            <div className="max-w-2xl">
              <p className="text-xs font-bold uppercase tracking-widest text-text">Tools I use</p>
              <p className="mt-2 text-sm text-muted">
                These are referral links. I may receive referral credit if you sign up through one.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              {referralLinks.map((link) => (
                <a
                  ...
                  className="inline-flex min-h-11 items-center gap-3 border-2 border-text bg-surface px-4 py-2 text-sm font-bold text-text transition-colors hover:border-accent hover:text-accent focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background"
                >
                  {link.name}

  ...
  return (
    <section className="relative min-h-[60vh] flex items-center border-b-4 border-text patterns-grid-bg-depth overflow-hidden">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <span className="hero-coord z-[2] top-4 right-14" aria-hidden="true">
        1,0
      </span>
      <div
      ...
      <div
        ...
        aria-hidden="true"
      />
      <span className="hero-coord z-[2] bottom-4 right-14" aria-hidden="true">
        1,1
      </span>
      ...
      <div
        className="hero-grid-dot z-[1]"
        style={{ top: '70%', left: '65%', animationDelay: '1.5s' }}
        aria-hidden="true"
      />
      <div
        className="hero-grid-dot z-[1]"
        style={{ top: '15%', left: '80%', animationDelay: '2.8s' }}
        aria-hidden="true"
      />
      <div
        className="hero-grid-dot z-[1]"
        style={{ top: '85%', left: '40%', animationDelay: '0.8s' }}
        aria-hidden="true"
      />
      <div
        className="hero-grid-dot z-[1]"
        style={{ top: '45%', left: '90%', animationDelay: '3.5s' }}
        aria-hidden="true"
      />
        ...
        >
          ...
          <m.div variants={slideUpVariants} className="flex flex-wrap gap-4 mb-8">
            <a
              ...
              className="inline-flex min-h-11 items-center gap-2 border-2 border-text px-4 py-2 text-sm font-semibold hover:bg-text hover:text-background transition-colors focus:outline-none focus:ring-4 focus:ring-text focus:ring-offset-4 focus:ring-offset-background"
            >
          ...
          <m.div variants={slideUpVariants} className="flex flex-wrap gap-4">
            ...
            <Link
              href="/blog"
              className="inline-flex items-center justify-center border-4 border-text bg-surface px-6 py-4 text-lg font-semibold text-text transition-colors hover:bg-text hover:text-background focus:outline-none focus:ring-4 focus:ring-text focus:ring-offset-4 focus:ring-offset-background"
            >
              Read the Blog
            </Link>
          </m.div>

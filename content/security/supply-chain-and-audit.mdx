...
Audit evidence becomes delivery control only when it binds to an exact candidate and an accountable decision. [Delivery Control Above the Agent Loop](/learn/harness/delivery-control-above-agent-loop) defines that authority boundary; this chapter defines the provenance and records it consumes.

...
thumbnailBlur: 'data:image/jpeg;base64,'
hero: '/images/posts/supervisor-in-the-machine-why-i-built-studio/hero.jpg'
heroBlur: 'data:image/jpeg;base64,'
published: true
author: 'Dakota Smith'
keywords:
  [
    'AI coding supervision',
    'AI code drift',
    'LLM orchestration',
...
[ORC](https://github.com/smithdak/ORC) decomposed development into specialists: Architect, Security Engineer, Database Engineer, Frontend Specialist, QA, Technical Writer, and more. It added codebase analysis, Epic→Feature→Story planning, anti-slop detection, and pattern learning.
...
[STUDIO](https://github.com/smithdak/studio) returns to three agents: Planner, Builder, Content Writer. The difference is supervision.
...
```bash
claude
/plugin marketplace add https://github.com/smithdak/studio.git
...
GitHub: [smithdak/studio](https://github.com/smithdak/studio)

Where this thesis went next: [Compile Your Agentic System](/blog/compile-your-agentic-system) covers base, skillsmith, and ObjectCore — three projects that apply the same discipline to the config around the loop.

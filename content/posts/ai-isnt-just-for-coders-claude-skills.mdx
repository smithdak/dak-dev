...
keywords:
  [
    ...
    'AI productivity non-technical',
    'claude custom instructions',
    'AI reluctance workplace',
  ]
---
...
_This is Part 1 of a series on Claude Skills. [Part 2](/blog/claude-skills-power-user-guide) covers power-user techniques for building advanced Skills. [Part 3](/blog/claude-code-skills-agent-skills-standard) dives into Claude Code Skills and the Agent Skills open standard for developers._

...
server.tool(
  ...
  'File a new issue for a project',
  {
    ...
    category: z
      .enum(['bug', 'dependency', 'quality', 'structure', 'feature', 'tech-debt'])
      .optional(),

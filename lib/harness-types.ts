// Harness Engineering — the execution and delivery machinery around the model.
// Peer pillar of Learn, alongside Patterns, Toolkit, and Security. This module
// is client-safe (no fs).
...
// the four-pillar mental model stays legible.
...
export const HARNESS_CHAPTERS: HarnessChapterMeta[] = [
  {
    ...
    number: '01',
    description:
      'The core run loop: prompt, model, tool calls, results, repeat — and the stop conditions that end it.',
    order: 1,
  ...
  },
  {
    ...
    number: '02',
    description:
      'The token budget as the scarce resource: what occupies the window, the cost model, and what to evict.',
    order: 2,
  ...
  },
  {
    ...
    number: '03',
    description:
      'What survives a context-overflow boundary: summarization fidelity, the handoff, and designing for it.',
    order: 3,
  ...
  },
  {
    ...
    number: '04',
    description:
      'The signal-to-noise problem: verbose tool output, truncation, deferral, and protecting the window.',
    order: 4,
  ...
  },
  {
    ...
    number: '05',
    description:
      'Where steering actually lives: instruction hierarchy, the harness preamble, and layered precedence.',
    order: 5,
  ...
  },
  {
    ...
    number: '06',
    description:
      'Rolling your own loop with the Claude Agent SDK — when it pays off, and when to use the managed one.',
    order: 6,
  ...
  },
  {
    ...
    number: '07',
    description:
      'The layer above runtime harnesses: exact-candidate state, independent evidence, bounded authority, and accountable delivery decisions.',
    order: 7,

...
| UI / component / visual change                                                          | `/frontend-design`                                                                                                                                                              | Executive-editorial system + token/motion/a11y discipline                                         |
...
| Claude Code, OpenAI Codex, or GitHub Copilot capability question                        | Toolkit source registry + current official docs; use the vendor-specific research skill/subagent when available                                                                 | Separate documented capability from runtime-verified behavior                                     |
...
| A vendor agent runtime, SDK, or API mechanics question                                            | Vendor-specific research subagent      | Current official docs + local evidence     |
...
| 1 — Harness refs | `docs/research/*-expert-reference.md`       | Configuring agent runtime mechanics            |
